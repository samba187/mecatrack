...
function seed(): DemoDb {
  const garage: Garage = {
    ...
    tva_defaut: 20,
    conditions_paiement: "Paiement à la restitution du véhicule (espèces, carte ou chèque).",
    mentions_devis: "Devis gratuit, valable 30 jours. Les travaux ne débutent qu'après votre validation.",
